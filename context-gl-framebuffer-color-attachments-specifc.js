...
function setup(){
    ...
    const wrap = this._ctx.CLAMP_TO_EDGE;
    this._framebuffer = this._ctx.createFramebuffer([
        {attachmentPoint : 0,texture : this._ctx.createTexture2d({
            width,height,wrap,format:this._ctx.RGB
        })},
        {attachmentPoint : 1,texture : this._ctx.createTexture2d({
            width,height,wrap,format:this._ctx.RGBA
        })},
        {attachmentPoint : 2,texture : this._ctx.createTexture2d({
            width,height,wrap
        })}
    ]);
